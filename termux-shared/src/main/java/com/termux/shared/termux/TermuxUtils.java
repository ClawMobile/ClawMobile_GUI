...
public class TermuxUtils {
    ...
    public static String getReportIssueMarkdownString(@NonNull final Context context) {
        ...
        markdownString.append("## ClawMobile Support");

        markdownString.append("\n\n").append(context.getString(R.string.msg_report_issue, TermuxConstants.TERMUX_SITE_URL)).append("\n");

        markdownString.append("\n\n### Website\n");
        markdownString.append("\n").append(MarkdownUtils.getLinkMarkdownString(TermuxConstants.TERMUX_SITE_URL, TermuxConstants.TERMUX_SITE_URL)).append("  ");
    ...
    public static String getImportantLinksMarkdownString(@NonNull final Context context) {
        ...
        markdownString.append("## ClawMobile Links");
